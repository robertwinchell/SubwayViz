...
M.Arc = function(o) {
	...
	my.w += my.linew;
	my.h += my.linew;
	my.aclock = (o.aclock === undefined)? 0:
			(my.ccw? 12 - o.aclock: o.aclock); // start on clock,
		// 0 = 12 o'clock
	my.bclock = (o.bclock === undefined)? 11:
			(my.ccw? 12 - o.bclock: o.bclock); // ending on clock
	my.center = my.r + my.linew * 0.5;
	my.endpoint = (my.bclock - my.aclock) * 30;
	my.startY = my.center - my.r;
	my.anim = function(time, animtype, callafter) {
		my.div.show();
		Snap.animate(0, my.endpoint, function(val) {
			my.arc.remove();
			var d = val,
				dr = d - 90;
			...
			var degstart = my.aclock * 30 + (my.ccw?  - d + 180: 0);
			my.arc.transform("r" + degstart + "," + my.center +
						"," + my.center + "4");
			my.arc.attr({
