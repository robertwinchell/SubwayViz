var input_tree = {
 "nodes": {
  "F": ["Data Platform Fundamentals", {"colors": ["transparent", "gray", "rgba(126, 126, 126, 0.5)"]}],
  ...
  "P": ["Database Application Development",
	{"colors": ["transparent", "gray", "rgba(126, 126, 126, 0.5)"], "par": "F", "nl": "cr"}],
  ...
  "E": ["Enterprise BI Development",
	{"colors": ["white", "gray", "rgba(255, 0, 0, 0.5)"], "par": "F"}],
  ...
  "A": ["Advanced Analytics",
	{"colors": ["white", "gray", "rgba(0, 0, 255, 0.5)"], "par": "E1"}],
